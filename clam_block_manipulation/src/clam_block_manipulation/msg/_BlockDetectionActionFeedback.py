"""autogenerated by genmsg_py from BlockDetectionActionFeedback.msg. Do not edit."""
...
class BlockDetectionActionFeedback(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','clam_block_manipulation/BlockDetectionFeedback']
