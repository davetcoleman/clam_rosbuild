"""autogenerated by genmsg_py from InteractiveBlockManipulationActionResult.msg. Do not edit."""
...
class InteractiveBlockManipulationActionResult(roslib.message.Message):
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','clam_block_manipulation/InteractiveBlockManipulationResult']
