...
private:
  static const char* __s_getDataType_() { return "clam_block_manipulation/BlockDetectionResult"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "fe4272fcc0cf26cf952b16d66c620bd4"; }
public:
...
public:
  ...
  ROS_DEPRECATED virtual uint8_t *serialize(uint8_t *write_ptr, uint32_t seq) const
  {
    ...
    ros::serialization::serialize(stream, blocks);
  ...
  ROS_DEPRECATED virtual uint8_t *deserialize(uint8_t *read_ptr)
  {
    ...
    ros::serialization::deserialize(stream, blocks);
    return stream.getData();
  }
  ...
  {
    uint32_t size = 0;
    size += ros::serialization::serializationLength(blocks);
    return size;
  }
