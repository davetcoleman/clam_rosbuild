...
private:
  static const char* __s_getDataType_() { return "clam_block_manipulation/BlockDetectionGoal"; }
public:
...
private:
  static const char* __s_getMD5Sum_() { return "55e74460cfe309311425690ecb457a45"; }
public:
...
public:
  ...
  ROS_DEPRECATED virtual uint8_t *serialize(uint8_t *write_ptr, uint32_t seq) const
  {
    ...
    ros::serialization::serialize(stream, table_height);
    ros::serialization::serialize(stream, block_size);
  ...
  ROS_DEPRECATED virtual uint8_t *deserialize(uint8_t *read_ptr)
  {
    ...
    ros::serialization::deserialize(stream, table_height);
    ros::serialization::deserialize(stream, block_size);
    return stream.getData();
  }
  ...
  ROS_DEPRECATED virtual uint32_t serializationLength() const
  {
    ...
    size += ros::serialization::serializationLength(table_height);
    size += ros::serialization::serializationLength(block_size);
    return size;
  }
